...
public class Page {
	...
	public Page(Integer totalCount, Integer totalPage, Integer currentPage, 
			Integer pageSize, String search, String keyword, 
			String order, Integer to, Integer from) {
		...
		this.to = (currentPage-1)*pageSize+1;
		this.from = (this.to-1)+pageSize;
	}
