...
<body>
	...
	<div class=join>
		...
		<div class="input">
			<sform:form id="joinForm" method="post" action="" modelAttribute="user">
				<fieldset>
					...
					<table>
						...
						<tr>
							...
							<td><sform:input type="text" path="representPhone" placeholder="ex)031-xxx-xxxx"/> 
							<span id="vali" class="representPhone">-포함 국번으로 입력</span></td>
						</tr>
						<tr>
							<td><sform:label path="handPhone" class="join_input">휴대폰연락처</sform:label></td>
							<td><sform:input type="text" path="handPhone" placeholder="ex)010-xxxx-xxxx"/> 
							<span id="vali" class="handPhone">-포함 11~12자리 핸드폰 번호 입력</span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><sform:input type="text" path="zipNo" placeholder="우편번호" readonly="readonly"/>
								<button id="addressSearch">주소검색</button> 
								<span id="vali" class="addressInput"></span></td>
						</tr>
						<tr>
							<td><sform:label path="address" class="join_input"></sform:label></td>
							<td><div class="address">
									<sform:input type="text" path="address" placeholder="주소" readonly="readonly"/>
								</div></td>
						</tr>
						<tr>
				...
				<sform:button id="joinCancel" value="취소"/>
			</sform:form>
		</div>
	</div>
